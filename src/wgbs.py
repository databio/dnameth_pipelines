...
def main(cmdl):
	...
	if args.epilog:
		...
		epi_cmd = get_epi_cmd(tools.episcall, out_dedup_sorted, resources.methpositions,
	...
	if resources.bismark_spikein_genome:
		...
		ngstk.make_sure_path_exists(spikein_folder)
		epi_cmd = get_epi_cmd(tools.episcall, out_spikein_sorted, resources.spikein_methpositions,
